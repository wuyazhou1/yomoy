package com.nsc.AmoskiGoods.Util;
...
public class GenericRepositoryGoodsImpl {
    protected final Logger logger = LoggerFactory.getLogger(GenericRepositoryGoodsImpl.class);
    private SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    @PersistenceContext
    //@Autowired
    //@Qualifier("entityManagerFactoryGoods")
    ...
    @Autowired
    @Qualifier("GoodsNamedParameterJdbcTemplate")
