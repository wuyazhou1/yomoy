...
import com.nsc.Amoski.WXPay.WXPayConstants.SignType;

public class WXPay {

    private WXPayConfigUtil config;
    ...
    public WXPay(final WXPayConfigUtil config) throws Exception {
        this(config, null, true, false);
    }

    public WXPay(final WXPayConfigUtil config, final boolean autoReport) throws Exception {
        this(config, null, autoReport, false);
    }


    public WXPay(final WXPayConfigUtil config, final boolean autoReport, final boolean useSandbox) throws Exception{
        this(config, null, autoReport, useSandbox);
    }

    public WXPay(final WXPayConfigUtil config, final String notifyUrl) throws Exception {
        this(config, notifyUrl, true, false);
    }

    public WXPay(final WXPayConfigUtil config, final String notifyUrl, final boolean autoReport) throws Exception {
        this(config, notifyUrl, autoReport, false);
    }

    public WXPay(final WXPayConfigUtil config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        this.config = config;
...
//        }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        System.out.println("签名随机数：==========="+msgUUID);
