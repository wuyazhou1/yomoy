package com.nsc.Amoski.repository;
...
//        list.add(entity);
     ...
     * @Description: 测试方法
     * @author: wusiyao
     * @date: 2019/11/5 18:02
     */
    public static void main(String[] args){
        Map<String, String> updateSqlAll = BeanCopyUtil.getUpdateSqlAll(new TMemberEntity());
        String sql = updateSqlAll.get("update")+updateSqlAll.get("where");
        System.out.println(sql);
    }
    ...
    public <T> List<T> query(T obj , String where,Map<String,Object> map,String dataBase){
        List list = jdbcTemplate.query(BeanCopyUtil.getQuerySql(obj,dataBase) + " where " + where,map, new BeanPropertyRowMapper(obj.getClass()));
        return list;
    }
    /**
     * sql执行数据
