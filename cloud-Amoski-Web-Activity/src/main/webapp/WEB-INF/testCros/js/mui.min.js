...
(function($, window, document, name) {
	...
	var removeBackdrop = function(popover) {
		backdrop.setAttribute('WEB-INF.testCros.css.style', 'opacity:0');
	...
	var togglePopover = function(popover, anchor, state) {
		...
		backdrop.setAttribute('WEB-INF.testCros.css.style', '');
	...
	var calPosition = function(popover, anchor, isActionSheet) {
		...
		if (position === 'top' || position === 'bottom') {
			...
			if (arrow) {
				...
				arrow.setAttribute('WEB-INF.testCros.css.style', 'left:' + arrowLeft + 'px');
			}
		} else if (position === 'middle') {
			arrow.setAttribute('WEB-INF.testCros.css.style', 'display:none');
		}
	...
	$.createMask = function(callback) {
		...
		mask.show = function() {
			mask._show = true;
			element.setAttribute('WEB-INF.testCros.css.style', 'opacity:1');
		...
		mask._remove = function() {
			if (mask._show) {
				mask._show = false;
				element.setAttribute('WEB-INF.testCros.css.style', 'opacity:0');
				$.later(function() {
					var body = document.body;
