...
;!function(e, t) {
    ...
    r.prompt = function(e, t) {
        ...
        r.open(i.extend({
            ...
            yes: function(i) {
                var n = s.val();
                "" === n ? s.focus() : n.length > (e.maxlength || 500) ? r.tips(" Maximum input " + (e.maxlength || 500) + " Word count ", s, {
                    tips: 1
                }) : t && t(n, i, s)
            }
        }, e))
    ...
    r.photos = function(t, n, a) {
        ...
        t.photos) {
            ...
            o(u[d].src, function(n) {
                ...
                r.close(s.loadi),
                r.msg("The current picture address is abnormal <br> Would you like to continue with the next one? ", {
                    time: 3e4,
                    btn: [" Next ", " No, I don't see "],
                    yes: function() {
