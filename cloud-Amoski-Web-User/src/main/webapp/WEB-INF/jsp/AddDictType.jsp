...
<script>
    ...
    function save(type){
        ...
        var url=null;
        if(source=='add')
            url = '/AmoskiUser/DictType/AddDictType';
        else
            url = '/AmoskiUser/DictType/UpdateDictType';
        $.ajax({
            type: 'POST',
            dateType: 'JSON',
    ...
    $(function(){
        ...
        jQuery.validator.addMethod("isAjaxExistense", function(value, element) {
            ...
            $.ajax({
                ...
                url: "/AmoskiUser/DictType/CheckedDictType",
    ...
    /*初始化新增部门方法*/
    function add(){
        $("#parentCode").val(window.parent["getSelectedCode"]());
    }
    ...
    <div class="page-add" style="padding-left: 3%;">
        <form action="" method="post" class="form form-horizontal" id="layer_form">
            ...
            <table style="width:80%">
                <tr class="trs">
                    ...
                    <td colspan="2" class="tableValue" style="width: 30%;">
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" id="code" name="code" data-name="字典类型代码" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs">
                    <td class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>上级字典类型：</label>
                    </td>
                    <td colspan="2"  class="tableValue"  style="width: 30%;">
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <select class="input-text" data-name="上级字典类型" id="parentCode" name="parentCode" style="width: 100%;">
                                <option value="">请选择上级字典类型</option>
                            </select>
                        </div>
                    </td>
                </tr>
                <tr class="trs">
                    <td  class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>字典类型名字：</label>
                    </td>
                    <td  colspan="2" >
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" data-name="字典类型名字" id="dictName" name="dictName" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs">
