...
<script>
    ...
    function save(type){
        ...
        var url=null;
        if(source=='add')
            url = '/AmoskiUser/MenuManage/AddMenuManage';
        else
            url = '/AmoskiUser/MenuManage/UpdateMenuManage';
        $.ajax({
            type: 'POST',
            dateType: 'JSON',
    ...
    $(function(){
        ...
        for(var i=0;i<getZtreeData.length;i++){
            $("#parentCode").append("<option value='"+getZtreeData[i].id+"'>"+getZtreeData[i].name+"</option>")
        }
        validate();
        window[source]();
        jQuery.validator.addMethod("isAjaxExistense", function(value, element) {
            ...
            $.ajax({
                ...
                url: "/AmoskiUser/MenuManage/checkedMenuIsExists",
            ...
            <table style="width:80%">
                <tr class="trs">
                    <td class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>菜单代码：</label>
                    </td>
                    <td colspan="2" class="tableValue" style="width: 30%;">
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" id="code" name="code" data-name="菜单代码" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs">
                    <td class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>上级菜单代码：</label>
                    </td>
                    <td colspan="2"  class="tableValue"  style="width: 30%;">
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <select class="input-text" data-name="上级菜单代码" id="parentCode" name="parentCode" style="width: 100%;">
                ...
                <tr class="trs">
                    <td  class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>菜单名称：</label>
                    </td>
                    <td  colspan="2" >
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" data-name="菜单名称" id="menuName" name="menuName" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs">
                    <td  class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>排序编号：</label>
                    </td>
                    <td  colspan="2" >
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" data-name="排序编号" id="orderCode" name="orderCode" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs" id="orgCodeTr" name="orgCodeTr">
                    <td  class="tableTdTitle">
                        <label class="form-label col-xs-3 col-sm-3" style="width: auto;"><span class="c-red">*</span>菜单连接：</label>
                    </td>
                    <td  colspan="2" >
                        <div class="formControls col-xs-8 col-sm-9" style="width: 100%;">
                            <input type="text" class="input-text" data-name="菜单连接" id="menuUrl" name="menuUrl" style="width: 100%;">
                        </div>
                    </td>
                </tr>
                <tr class="trs">
